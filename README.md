...
### Beta - Download the app for Mac OS (MongoDB Compass v 1.2.81)
[Download MongoDB Compass + Darkmode](https://drive.google.com/file/d/1S5SJicFRzyvruw6BjhSYbxpn8w-76xb8/view?usp=sharing){:target="_blank"}
...
1. Download [MongoDB Compass](https://www.mongodb.com/try/download/compass){:target="_blank"} (tested on version 1.28.1 on MacOS 10.15.7)
